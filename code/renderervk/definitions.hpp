...
enum class Vk_Shader_Type : uint8_t
{
    ...
    TYPE_MD3_BLEND2_ADD,
    TYPE_MD3_BLEND2_ADD_ENV,
    TYPE_MD3_BLEND2_MUL,
    TYPE_MD3_BLEND2_MUL_ENV,
    TYPE_MD3_BLEND2_ALPHA,
    TYPE_MD3_BLEND2_ALPHA_ENV,
    TYPE_MD3_BLEND2_ONE_MINUS_ALPHA,
    TYPE_MD3_BLEND2_ONE_MINUS_ALPHA_ENV,
    TYPE_MD3_BLEND2_MIX_ALPHA,
    TYPE_MD3_BLEND2_MIX_ALPHA_ENV,

    TYPE_MD3_BLEND2_MIX_ONE_MINUS_ALPHA,
    TYPE_MD3_BLEND2_MIX_ONE_MINUS_ALPHA_ENV,

    TYPE_MD3_BLEND2_DST_COLOR_SRC_ALPHA,
    TYPE_MD3_BLEND2_DST_COLOR_SRC_ALPHA_ENV,

    TYPE_MD3_BLEND3_ADD,
    TYPE_MD3_BLEND3_ADD_ENV,
    TYPE_MD3_BLEND3_MUL,
    TYPE_MD3_BLEND3_MUL_ENV,
    TYPE_MD3_BLEND3_ALPHA,
    TYPE_MD3_BLEND3_ALPHA_ENV,
    TYPE_MD3_BLEND3_ONE_MINUS_ALPHA,
    TYPE_MD3_BLEND3_ONE_MINUS_ALPHA_ENV,
    TYPE_MD3_BLEND3_MIX_ALPHA,
    TYPE_MD3_BLEND3_MIX_ALPHA_ENV,
    TYPE_MD3_BLEND3_MIX_ONE_MINUS_ALPHA,
    TYPE_MD3_BLEND3_MIX_ONE_MINUS_ALPHA_ENV,

    TYPE_MD3_BLEND3_DST_COLOR_SRC_ALPHA,
    TYPE_MD3_BLEND3_DST_COLOR_SRC_ALPHA_ENV,
...
struct vk_tess_s
{
    ...
    vk::DeviceSize buf_offset[10]{};             // all zeros
    vk::DeviceSize vbo_offset[10]{};
...
struct Vk_Instance
{
    ...
    struct
    {
        struct
        {
            ...
            vk::ShaderModule md3_blend[2][2]{};    // env[0,1], fog[0,1]
