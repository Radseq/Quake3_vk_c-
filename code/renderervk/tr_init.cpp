...
static void R_LevelShot(void)
{
	...
	Com_sprintf(checkname, sizeof(checkname), "levelshots/%s.tga", tr.world->baseName.data());
...
static void GfxInfo(void)
{
	...
	{
		ri.Printf(PRINT_ALL, "RENDER: %d x %d, MODE: %d, %d x %d %s hz:", glConfig.vidWidth, glConfig.vidHeight, mode, gls.windowWidth, gls.windowHeight, fs.data());
	}
	else
	{
